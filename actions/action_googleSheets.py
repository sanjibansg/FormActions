...
def action_googleSheets(data):
    ...
    try:
        logging.info("[Action Google_Sheets] Fetching form & action data from respective DB")
    ...
    try:
        logging.info("[Action Google_Sheets] Connecting to Google Sheets with provided info")
    ...
    try:
        ...
        if num_curr_records<=0:
            logging.info("[Action Google_Sheets] Adding all form responses to Google Sheet")
            responses=[]
        ...
        # case when more than one record is required to be appended
            ...
            logging.info("[Action Google_Sheets] Adding multiple form responses to Google Sheet")
            responses=[]
